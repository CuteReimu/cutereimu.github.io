...
本路线是Any%速通玩家们最早使用的速通路线，但并不是目前的最快路线。目前最快路线是[Any%速通路线（酸泪线）](any-isma.md)。相比于酸泪线而言，本路线的难度会低很多。

Any%不可避免的是在只拥有零钉白波的情况下进行守望者骑士和乌姆的战斗，难度较大。如果新手玩家难以达成，但又非常想参与Any%速通的话，可以考虑使用[黑波路线](https://www.speedrun.com/hollowknight/guides/p2d5f)（英文版，可自行使用翻译工具），在本路线的基础上变化不大，方便在熟练之后过渡到本路线。
