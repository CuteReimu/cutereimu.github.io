...
Any%速通不可避免需要在只拥有零钉白波的情况下进行守望者骑士和乌姆的战斗，难度较大。如果新手玩家难以达成，但又非常想参与Any%速通的话，可以考虑使用[黑波路线](https://www.speedrun.com/hollowknight/guides/p2d5f)（英文版，可自行使用翻译工具），在本路线的基础上变化不大，方便在熟练之后过渡到本路线。
...
以上就是不走王后花园的路线调整，后续只有1.4.3.2版本利用蘑菇孢子BUG才需要有所变动
