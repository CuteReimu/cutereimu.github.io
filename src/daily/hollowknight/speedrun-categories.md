...
Steam上下载的空洞骑士默认是最新版本，如果你想要降到1.4.3.2或1.2.2.1，直接对Steam中的空洞骑士右键 &rarr; 属性，选择测试版，再选择想要降到的版本即可。（注意：此方法会覆盖原来的空洞版本，如果想要多版本共存请参考下述降版本教程）
...
值得一提的是，虽然 112% APB 和 107% AB 都是基于现版本的速通，但由于规则的细小区别，完成内容上会有些许偏差。
- 112% APB 规则上只要求击败万神殿中所有可能出现的boss，（除梦境左特外）均不要求在现实世界中击败，因此在现实世界中击败梦境boss只为了凑齐2400梦点，从而达成先知升天的完成度。所有的梦境boss和战士之梦加起来共有2700梦点，因此可以放弃一个300梦点的梦境boss，通常选择放弃灵魂暴君。梦魇之王没有精华，因此也不打，选择放逐。
- 107% AB 规则上要求击败所有boss，包括梦魇之王格林、梦境左特、灵魂暴君在内的所有梦境boss。
- 两者之间还有一个小区别：112% APB 因为从boss身上只收集2400精华，而使用梦之门会消耗一些精华，因此通常需要从低语之根中额外收集一些精华补齐。而 107% AB 会击败所有boss，因此不会缺少精华。
...
- 从一个新的存档开始（大部分榜单分为NMG、CP NMG、NMMS、允许任何邪道，少部分榜单分类不同，可前往speedrun.com查看）: 
  - **4 Mask Shards**: 收集4个面具碎片
  - **Myla&**: **击杀米拉**（击败灵魂大师并获得水晶之心后，米拉会完全感染，并且可被攻击）
  - **NKG%**: 击败梦魇之王格林（Nightmare King Grimm)
  - **0 Geo**: 不获得任何吉欧通关游戏
  - **3 Vessel Fragments**: 收集3个容器碎片
  - **A1uba%**: **击杀一只阿鲁巴**
  - **Al2ba%**: 击杀两只阿鲁巴
  - **All Charm Notches**: 获得所有护符槽
  - **All Stag Stations**: 解锁所有鹿角虫站
  - **All Whispering Roots**: 收集所有低语之根的全部482精华
  - **Cartographer**: 绘图师（收集所有地图后进入伊塞尔达的商店）
  - **Clawless Shade Cloak**: 在无螳螂爪的情况下获得黑冲
  - **Elderbug%**: 给虫长老送花
  - **Elegy%**: 获得蜕变挽歌护符
  - **Ghostbusters**: 鬼魂破坏者（放逐神居之外的所有鬼魂）
  - **Great Hopper%**: 击杀一只大跳虫
  - **GPZ%**: 击败灰色王子左特（Grey Prince Zote）
  - **Grubsong%**: 获得幼虫之歌护符
  - **Happy Couple**: 达成幸福的夫妇成就
  - **Hiveblood%**: 获得蜂巢之血护符
  - **Marissa Audience**: 玛丽莎的观众（与米莉贝利、4只发光子宫护符的幼体、编织者之歌、格林之子一起听玛丽莎唱歌）
  - **Mr. Mushroom Ending**: 达成蘑菇先生结局（时代的终结成就）
  - **Pantheon 5 Boss Order**: 按照圣巢万神殿的顺序击败现实世界的所有boss
  - **PoP%**: 通关苦痛之路（Path of Pain）
  - **Save Myla**: 拯救米拉（在米拉完全没有感染，也就是不击败灵魂大师且不获得水晶之心的情况下通关游戏，换句话说就是Any%的酸泪线）
  - **Spelless**: 无法术通关
  - **Who%**: 拯救王后花园最上方的幼虫
  - **Zote%**: 在愚人斗兽场击败左特
- 非流程通关类
