...
如果你喜欢火爆的项目，可以尝试一下。这个项目目前比较流行的路线有[超冲线](any.md)和[酸泪线](any-isma.md)。
...
这是跑图占比最高的项目，这个项目的[旧路线](all-skills-old.md)也是最适合新手入门的项目。

如果你想入门速通，可以尝试一下这个项目的[旧路线](all-skills-old.md)。这个项目现在也有更快但更难的[新路线](all-skills.md)。
