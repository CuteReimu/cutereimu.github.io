...
notation: |
  ...
  [V:1] a2 b a | g b e' {d'e'}d' | c' d' e' g' | [f']3 b |
  [V:2] F, [CA] [CA] [CA] | G, [EB] [EB] [EB] | A, [EAc] [EAc] [EAc] | B, [FBd] [FBd] [FBd] |
  [V:1] [ege']2 f' g' | [fbd'f']2 [e']/[f']/[e']/[d']/ | [ae'] d' c' [dd'] | [Bgb]3 g |
  [V:2] !pp! z [GBe] [GBe] [GBe] & E4 | B, [FBd] [FBd] [FBd] | A, [EAc] [EAc] [EAc] | !pp! z [B,EG] [B,EG] [B,EG] & [G,]4 |
  [V:1] f g a c' | [e']2 [d']/[e']//[d']//[c']/[d']/ | [e'] !pp![be'g'] [be'g'] [be'g'] | [be'g'] [be'g'] [be'g'] !mp!z//b//[c']//[d']// |
  [V:2] F, [A,CA] [A,CA] [A,CA] | B, [FBd] [FBd] !mp! C/D/ | E E/F/ G F | E B, G, !pp![B,B] |
  [V:1] [ee']2 [fd'f'] [gc'g'] | [fbd'f']2 [eae'] [dgd'] | [eae'] [dgd'] [eac'] [dbd'] | [Bgb]2 G/B/g/E/ |
  [V:2] [E,E] [EBe]/[EBe]/ [EBe] [EBe] | [B,,B,] [FBd]/[FBd]/ [FBd] [FBd] | [A,,A,] [EAc]/[EAc]/ [EAc] [EAc] | [G,,G,] [B,E]/[B,E]/ [B,E] z |
  [V:1] [Aa] B/c/ b [da] | [eg] [fb] [ee'] [d']//[e']//d'/ | !arpeggio![cc'] !arpeggio![dd'] !arpeggio![ee'] !arpeggio![gg'] | [ff']/[Bb]/[cc']/[dd']/ [ee']/[ff']/[gg']/[aa']/ |
  [V:2] [F,,F,] [A,CF]/[A,CF]/ [A,CF] [A,CF] | [G,,G,] [B,EG]/[B,EG]/ [B,EG] [B,EG] | [A,,A,] [A,CF]/[A,CF]/ [A,CF] [A,CF] | [B,,B,] [F,B,D]/[F,B,D]/ [F,B,D] [F,B,D] |
  ...
  [V:1] [bb']2 [aa']2- | [aa'] [gg'] [aa'] [ff']- | [ff']4 | B e/b/ z//c//d//e//f//g//a//b// |
  ...
  [V:2] [A,CA] e z e | z [Ace] [Ace] [Ace] & F4 | D B f F | B, F .G/.A/ z ||
  [V:1] !mp! .[Bb] .[Bb]/.[Aa]/ .[Gg] .[Bb] | [ee']3 .[ee'] | .[dd'] {e'd'}.c' .[dd'] .[ee'] | [ee']3 .[ee'] |
  ...
  [V:1] .[Bb] .[bb'] .[aa'] .[ff']/.[gg']/ | .[ff'] .[ee'] .[dd']/.f/ .[cc'] | .[dd'] {e'd'}.c' .[dd'] .[ee'] | [e']4 & b !pp!g f/g/ b |]
  [V:2] .[B,EG] .[B,EG]/.[B,EG]/ .[B,EG] .[B,EG] & [G,]4 | .[CEA] .[CEA]/.[CEA]/ .[CEA] .[CEA] & [A,]4 | .[DF] .[DF]/.[DF]/ .[DF] .[DF] & [B,]4 | .[G,B,E] .[G,B,E] .[G,B,E]/.[G,B,E]/ .[G,B,E] & [E,]4 |]
```
